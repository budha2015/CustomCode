	...
	<div id="wrapper">
		...
		<form name="login-form" class="login-form" action="checkRegister"
			...
			<div class="content">
				...
				<br> <br> <input name="userEmail" type="text"
					class="input username" placeholder="Email" />
				<div class="user-icon"></div>
				<input name="password" type="password" class="input password"
					placeholder="Password" />
				<div class="pass-icon"></div>
				<br> <br> <select name="userGender" class="input username"
					placeholder="gender">
					<option label="--Select Gender--" value="-1" />
					<option label="Male" value="M" />
					<option label="Female" value="F" />
				</select>
				<div class="user-icon"></div>
				<br> <br> <input name="phoneNo" type="text"
					class="input username" placeholder="phone number" />
				<div class="user-icon"></div>
				<br> <br>
				<textarea name="address" class="input username"
